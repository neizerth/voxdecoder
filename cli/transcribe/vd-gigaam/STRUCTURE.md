...
Crate lives at `cli/transcribe/vd-gigaam/` in the repo:

```
cli/transcribe/vd-gigaam/
├── Cargo.toml
├── src/
│   ├── main.rs
│   ├── cli/
...
Docs for this binary: `cli/transcribe/vd-gigaam/` (this folder).
