...
| tests (CLI) | `src/cli/fix/vd-fix-disfluency/tests/{unit,e2e}/` | `./scripts/test.sh vd-fix-disfluency` |

**Status: implemented.** Workspace members: shared crates + `vd-fix-disfluency`. No optional downloadable assets — the rule tables are compiled in.
