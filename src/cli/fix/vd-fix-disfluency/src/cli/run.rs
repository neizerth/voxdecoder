//! `vd-fix-disfluency run` implementation.
...
use crate::disfluency::{DisfluencyFixer, DisfluencyLoadOptions};
use crate::progress::{Progress, ProgressEvent};
use crate::types::{FixOptions, Language, Mode, ProgressFormat, TextSpan};
...
pub fn execute(args: RunArgs) -> Result<(), CliError> {
    ...
    let fixer = DisfluencyFixer::load(DisfluencyLoadOptions {
