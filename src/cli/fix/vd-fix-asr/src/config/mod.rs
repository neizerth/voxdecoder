...
impl FileConfig {
    pub fn get(&self, key: &str) -> Result<String, String> {
        ...
        match key {
            ...
            "context_neighbors" => Ok(self
                .context_neighbors
                .unwrap_or(d.context_neighbors)
                .to_string()),
    ...
    pub fn set(&mut self, key: &str, value: &str) -> Result<(), String> {
        match key {
            ...
            "context_neighbors" => {
                self.context_neighbors = Some(
                    value
                        .parse()
                        .map_err(|_| format!("invalid context_neighbors: {value}"))?,
                );
            }
    ...
    pub fn list_lines(&self) -> Vec<String> {
        ...
        vec![
            ...
            format!(
                "context_neighbors = {}",
                self.context_neighbors.unwrap_or(d.context_neighbors)
            ),
        ]
    }
}
