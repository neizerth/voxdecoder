...
| tests (CLI) | `src/cli/fix/vd-fix-terms/tests/{unit,e2e}/` | `./scripts/test.sh vd-fix-terms` |

Shared crates: [`src/crates/`](../../../crates/). Change artifact / `.fixed.` / progress there — not in this crate. Terms-only `lexicon/` / `terms/` stay here.
